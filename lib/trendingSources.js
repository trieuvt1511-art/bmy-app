...
// Danh sách 4 nguồn ổn định đã được verify trực tiếp từ Vercel runtime:
//   thekitchn, bonappetit, eater  → 3 nguồn tiếng Anh
//   afamily-amthuc                 → 1 nguồn tiếng Việt
//
...
//   - kenh14 an-quay-di: /an-quay-di.rss trả 404 (Kenh14 đã đổi slug category)
//
// TODO: tìm thêm 1-2 nguồn RSS ẩm thực Việt ổn định. Hiện AFamily là nguồn
// duy nhất nhưng đã đủ 3 items mix với 9 items quốc tế → 12 items/ngày.
...
// Giảm xuống 8 để đảm bảo rewrite pipeline không chạm maxDuration 60s
// của Vercel Hobby plan (2 workers × 4 batches × ~6s/call ≈ 24s).
export const MAX_TRENDING_ITEMS = 8;
