...
// SVG data-URL placeholder with B'My branding.
// Used for recipes where we haven't yet sourced a real product photo.
// Deterministic, no external dependency, works offline.
// Replace with real Unsplash/B'My photo when available.
const BMY_PALETTES = [
  ["#FF6B35", "#E63946"], // 0 warm red
  ["#F4A261", "#E76F51"], // 1 sand terracotta
  ["#2A9D8F", "#264653"], // 2 teal
  ["#FFB703", "#FB8500"], // 3 gold orange
  ["#E07A5F", "#81B29A"], // 4 clay sage
];
const bmyPlaceholder = (name, paletteIndex = 0) => {
  const [a, b] = BMY_PALETTES[paletteIndex % BMY_PALETTES.length];
  const safe = String(name).replace(/[<>&"']/g, "");
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800" preserveAspectRatio="xMidYMid slice"><defs><linearGradient id="g" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="${a}"/><stop offset="1" stop-color="${b}"/></linearGradient></defs><rect width="1200" height="800" fill="url(#g)"/><text x="600" y="390" text-anchor="middle" fill="white" font-size="78" font-family="Georgia,serif" font-weight="700">${safe}</text><text x="600" y="470" text-anchor="middle" fill="white" font-size="32" font-family="Georgia,serif" opacity="0.88" font-style="italic">B'My Kitchen</text></svg>`;
...
export const BMY_RECIPES = [
  ...
  make(2, {
    ...
    strMealThumb: bmyPlaceholder("Bánh Mì Thịt Nướng", 0),
    timeMin: 45,
    difficulty: "medium",
    region: "Nam",
    strInstructions:
  ...
  make(3, {
    ...
    strCategory: "Noodles",
    strMealThumb: bmyPlaceholder("Bún Chả Hà Nội", 1),
    timeMin: 60,
    difficulty: "medium",
    region: "Bắc",
    strInstructions:
  ...
  make(4, {
    ...
    strMealThumb: bmyPlaceholder("Gỏi Cuốn Tôm Thịt", 2),
    timeMin: 30,
    difficulty: "easy",
    region: "Nam",
    strInstructions:
  ...
  make(5, {
    ...
    strCategory: "Rice",
    strMealThumb: bmyPlaceholder("Cơm Tấm Sườn Nướng", 3),
    timeMin: 60,
    difficulty: "medium",
    region: "Nam",
    strInstructions:
  ...
  make(8, {
    ...
    strCategory: "Street Food",
    strMealThumb: bmyPlaceholder("Bánh Xèo Miền Trung", 4),
    timeMin: 60,
    difficulty: "medium",
    region: "Trung",
    strInstructions:
  ...
  make(20, {
    ...
    strCategory: "Appetizer",
    strMealThumb: bmyPlaceholder("Nem Rán Chả Giò", 0),
    timeMin: 60,
    difficulty: "medium",
    region: "Bắc",
    strInstructions:
  ...
  make(24, {
    ...
    strMealVi: "Xôi Xéo",
    strCategory: "Breakfast",
    strMealThumb: bmyPlaceholder("Xôi Xéo Hà Nội", 3),
    timeMin: 75,
    difficulty: "medium",
    region: "Bắc",
    strInstructions:
